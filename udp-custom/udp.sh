...
sleep 1
wget -q -O /usr/bin/usernew https://raw.githubusercontent.com/Mark-HDR/Script-XRAY/master/udp-custom/ssh/usernew.sh
wget -q -O /usr/bin/trial https://raw.githubusercontent.com/Mark-HDR/Script-XRAY/master/udp-custom/ssh/trial.sh
echo "\e[1;32m Proses Download Script Slowdns.. \e[0m"
wget https://raw.githubusercontent.com/Mark-HDR/Script-XRAY/master/udp-custom/slowdns/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
sleep 1
echo "\e[1;32m Proses Download Script OpenVPN.. \e[0m"
wget https://raw.githubusercontent.com/Mark-HDR/Script-XRAY/master/udp-custom/openvpn/openvpn.sh && chmod +x openvpn.sh && ./openvpn.sh
sleep 1
